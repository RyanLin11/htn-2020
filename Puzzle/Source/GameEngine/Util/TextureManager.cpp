...
TextureManager::~TextureManager() { UnLoadTextures(); }
...
sf::Vector2f GetTextureTileSize(GameEngine::eTexture::type texture) {
  ...
  case GameEngine::eTexture::PlayerLeft:
    return sf::Vector2f(45.f, 45.f);
  case GameEngine::eTexture::PlayerRight:
    return sf::Vector2f(45.f, 45.f);
  case GameEngine::eTexture::PlayerUp:
    return sf::Vector2f(45.f, 45.f);
  case GameEngine::eTexture::PlayerDown:
    return sf::Vector2f(45.f, 45.f);
  }
